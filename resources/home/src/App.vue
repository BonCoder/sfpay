<template>
  <div id="app" ref="app">
    ...
    <Alert v-show="alert" type="error">{{msg}}</Alert>
    <router-view @login="Login" @alert="showAlert" @search="isSearch" class="view" :show="showInp" @scroll="scroll($event)"></router-view>
...
export default {
  ...
  created() {
    var user = localStorage.getItem("user_a");
